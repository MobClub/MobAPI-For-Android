...
import com.mob.mobapi.sample.car.CarViolationActivity;
...
public class MainActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.btnCarViolationApi).setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.btnTiKuApi: startActivity(new Intent(this, TiKuAPIActivity.class)); break;
			case R.id.btnCarApi: startActivity(new Intent(this, CarAPIActivity.class)); break;
			case R.id.btnFootballLeagueApi: startActivity(new Intent(this, FootballLeagueAPIActivity.class)); break;
			case R.id.btnCarViolationApi: startActivity(new Intent(this, CarViolationActivity.class)); break;
		}
	}
