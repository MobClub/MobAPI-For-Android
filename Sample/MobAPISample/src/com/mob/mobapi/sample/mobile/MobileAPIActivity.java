...
public class MobileAPIActivity extends Activity implements OnClickListener, APICallback {
	...
	public void onSuccess(API api, int action, Map<String, Object> result) {
		...
		tvProvince.setText(com.mob.tools.utils.ResHelper.toString(address.get("province")));
		tvCity.setText(com.mob.tools.utils.ResHelper.toString(address.get("city")));
		tvCityCode.setText(com.mob.tools.utils.ResHelper.toString(address.get("cityCode")));
		tvMobileNumber.setText(com.mob.tools.utils.ResHelper.toString(address.get("mobileNumber")));
		tvZipCode.setText(com.mob.tools.utils.ResHelper.toString(address.get("zipCode")));
		tvOperator.setText(com.mob.tools.utils.ResHelper.toString(address.get("operator")));
	}
